...
import (
	...
	"github.com/zgfh/go-demo/cmd/demo-http/restapi/operations"
	"github.com/zgfh/go-demo/cmd/demo-http/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../demo-http --name TodoList --spec ../swagger.yml
